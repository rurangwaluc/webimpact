...
export const metadata: Metadata = {
  ...
  description:
    "WebImpact Lab builds custom software, internal systems, dashboards, portals, and business tools for companies in Rwanda and East Africa.",
  alternates: {
    canonical: "/services/software-development",
  },
  openGraph: {
    title: "Custom Software Development in Rwanda | WebImpact Lab",
    description:
      "Custom software for businesses that need better control, clearer reporting, less manual work, and stronger operations.",
    url: "https://webimpactlab.com/services/software-development",
    type: "website",
  },
};

const problems = [
  "Your business depends on Excel, WhatsApp, notebooks, or memory.",
  "Your team repeats work that software should already handle.",
  "You cannot clearly see daily work, customers, staff activity, or performance.",
  "Your tools do not connect, so mistakes and losses stay hidden.",
];
...
const builds = [
  {
    ...
    text: "Tools that organize daily work, approvals, tasks, records, and team activity in one place.",
  },
  {
    icon: Layers3,
    title: "Operations platforms",
    text: "Systems that connect branches, teams, customers, managers, and business activity into one clear workflow.",
  },
  {
    icon: Database,
    title: "Reporting tools",
    text: "Clear reports and dashboards that help owners see what is happening before small problems become expensive.",
  },
  {
    icon: ShieldCheck,
    title: "Control and accountability",
    text: "User roles, approvals, activity records, and clear evidence for important business actions.",
  },
];
...
const process = [
  ["01", "Audit", "Find where the business is losing time, money, or control."],
  [
    "02",
    "Scope",
    "Define what the system must do, who will use it, and what success looks like.",
  ],
  [
    "03",
    "Design",
    "Map the screens and workflow so the system is clear before development starts.",
  ],
  [
    "04",
    "Build",
    "Build in focused phases, review progress, test properly, and avoid feature chaos.",
  ],
  [
    "05",
    "Improve",
    ...
    <main className="bg-white dark:bg-[#070707]">
      <JsonLd
        data={{
          ...
          "@type": "Service",
          name: "Custom Software Development in Rwanda",
          provider: {
            "@type": "Organization",
            name: "WebImpact Lab",
          ...
          url: "https://webimpactlab.com/services/software-development",
          description:
            "Custom software development for businesses that need internal systems, dashboards, portals, automation, reporting, and better control.",
        }}
      />
        ...
        <div className="mx-auto max-w-7xl">
          <div className="relative overflow-hidden rounded-[2.75rem] border border-black/10 bg-[#f7f7f7] shadow-2xl shadow-black/[0.06] dark:border-white/10 dark:bg-[#111111]">
            ...
            <div className="relative grid gap-10 p-6 sm:p-8 lg:grid-cols-[1.08fr_0.92fr] lg:p-12 xl:p-16">
              <div>
                <p className="text-xs font-black uppercase tracking-[0.22em] text-[#fd5b38]">
                  Custom software development in Rwanda
                </p>
                ...
                <h1 className="mt-4 max-w-4xl text-[clamp(2.05rem,5.6vw,4.35rem)] font-semibold leading-[0.96] tracking-[-0.065em] text-black dark:text-white">
                  Stop forcing your business to run on tools it has already
                  outgrown.
                </h1>

                <p className="mt-6 max-w-2xl text-[15px] leading-7 text-black/62 dark:text-white/62 sm:text-base">
                  WebImpact Lab builds custom software for businesses in Kigali,
                  Rwanda, and East Africa that need better daily work, clearer
                  reports, stronger control, and systems that can grow beyond
                  manual work.
                </p>

                <p className="mt-4 max-w-2xl text-sm font-semibold leading-6 text-black/78 dark:text-white/78">
                  We do not build random features. We find the business leak,
                  then build the tool, dashboard, portal, or workflow that helps
                  close it.
                </p>
              ...
              <div className="rounded-[2.25rem] border border-black/10 bg-white p-5 shadow-xl dark:border-white/10 dark:bg-[#070707] sm:p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-semibold text-black/45 dark:text-white/45">
                      Work, users, reports, decisions, and control.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-6 rounded-[1.75rem] border border-[#fd5b38]/20 bg-[#fd5b38]/10 p-5">
                  ...
                  <p className="mt-2 text-sm leading-6 text-black/65 dark:text-white/65">
                    If the system does not save time, reduce mistakes, improve
                    visibility, or help the business grow, it should not be
                    built.
                  </p>
                </div>
              </div>
            ...
            <div className="relative border-t border-black/10 px-6 py-4 text-sm font-semibold text-black/55 dark:border-white/10 dark:text-white/55 sm:px-8 lg:px-12">
              Internal systems → Dashboards → Portals → Workflows → Growth
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.42fr_1fr] lg:gap-16">
            <div className="lg:sticky lg:top-28 lg:self-start">
              ...
              <h2 className="mt-4 max-w-md text-[clamp(2rem,5vw,3.35rem)] font-semibold leading-[1] tracking-[-0.055em] text-black dark:text-white">
                Custom software built around the way your business actually
                works.
              </h2>

              <p className="mt-5 max-w-md text-[15px] leading-7 text-black/60 dark:text-white/60">
                Good software should make work clearer, faster, and easier to
                control. It should not confuse your team or create another
                problem to manage.
              </p>
            </div>
            ...
            <div className="relative grid gap-10 lg:grid-cols-[0.85fr_1.15fr]">
              <div>
                ...
                <h2 className="mt-4 max-w-xl text-[clamp(2rem,5vw,3.35rem)] font-semibold leading-[1] tracking-[-0.055em] text-black dark:text-white">
                  Good software should make the business easier to run, not
                  harder.
                </h2>

                <p className="mt-5 max-w-xl text-[15px] leading-7 text-black/62 dark:text-white/62">
                  Custom software only makes sense when it creates a clear
                  advantage: faster work, fewer mistakes, better visibility, and
                  stronger control.
                </p>
              </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 lg:grid-cols-[0.42fr_1fr] lg:gap-16">
            <div>
              ...
              <h2 className="mt-4 max-w-md text-[clamp(2rem,5vw,3.35rem)] font-semibold leading-[1] tracking-[-0.055em] text-black dark:text-white">
                We reduce software risk before development gets expensive.
              </h2>

              <p className="mt-5 max-w-md text-[15px] leading-7 text-black/60 dark:text-white/60">
                Software projects fail when people build before they understand
                the work. We start with clarity, then build in focused phases.
              </p>
            </div>
            ...
            <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                ...
                <h2 className="mt-4 max-w-2xl text-[clamp(2rem,5vw,3.35rem)] font-semibold leading-[1] tracking-[-0.055em] text-black dark:text-white">
                  Have a workflow your business has outgrown?
                </h2>

                <p className="mt-5 max-w-xl text-[15px] leading-7 text-black/60 dark:text-white/60">
                  Tell us what your business is trying to manage, automate, or
                  control. We will help you decide what kind of software should
                  be built first.
                </p>
              </div>
