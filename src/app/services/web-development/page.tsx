...
export const metadata: Metadata = {
  ...
  description:
    "WebImpact Lab builds business websites that explain your offer, build trust, rank on Google, and turn visitors into real customers in Rwanda and East Africa.",
  alternates: {
    canonical: "/services/web-development",
  },
  openGraph: {
    title: "Web Development Company in Rwanda | WebImpact Lab",
    description:
      "Websites built to explain, rank, and convert. Not just design, but real business results.",
    url: "https://webimpactlab.com/services/web-development",
    type: "website",
  },
};

const problems = [
  "Your website looks okay, but it does not bring serious customers.",
  "Visitors land on your site and leave without taking action.",
  "Your offer is unclear, so people do not quickly understand why they should trust you.",
  "Your website does not show up when people search for your service on Google.",
];
...
const builds = [
  {
    ...
    text: "Websites that clearly explain what you do, who it is for, and why people should choose your business.",
  },
  {
    icon: Search,
    title: "SEO-ready pages",
    text: "Pages structured around the words your customers search for, so your business can build long-term visibility.",
  },
  {
    icon: MousePointerClick,
    title: "Conversion-focused layouts",
    text: "Page sections designed to guide visitors toward calling, messaging, booking, buying, or requesting a quote.",
  },
  {
    icon: ShieldCheck,
    title: "Trust-building structure",
    text: "Clear messaging, proof, services, case studies, FAQs, and calls-to-action that make your business look serious.",
  },
];
...
const process = [
  [
    "01",
    "Clarify the offer",
    "We understand what you sell, who you serve, and why customers should choose you.",
  ],
  [
    "02",
    "Structure the pages",
    "We define the pages, sections, message, proof, and calls-to-action your website needs.",
  ],
  [
    "03",
    "Design for trust",
    "We create a clean, modern experience that feels serious on phone, tablet, and desktop.",
  ],
  [
    "04",
    "Build for speed and SEO",
    "We develop a fast, responsive website with strong page structure and search-friendly content.",
  ],
  [
    "05",
    ...
    <main className="bg-white dark:bg-[#070707]">
      <JsonLd
        data={{
          ...
          "@type": "Service",
          name: "Web Development Company in Rwanda",
          provider: {
            "@type": "Organization",
            name: "WebImpact Lab",
          ...
          url: "https://webimpactlab.com/services/web-development",
          description:
            "Web development services for businesses that need websites that explain, rank, and convert.",
        }}
      />
          ...
          <div className="relative overflow-hidden rounded-[2.75rem] border border-black/10 bg-[#f7f7f7] shadow-2xl shadow-black/[0.06] dark:border-white/10 dark:bg-[#111111]">
            ...
            <div className="relative grid gap-10 p-6 sm:p-8 lg:grid-cols-[1.08fr_0.92fr] lg:p-12 xl:p-16">
              <div>
                ...
                <h1 className="mt-4 max-w-4xl text-[clamp(2.05rem,5.6vw,4.2rem)] font-semibold leading-[0.96] tracking-[-0.065em] text-black dark:text-white">
                  A website should bring customers, not just look nice.
                </h1>

                <p className="mt-6 max-w-2xl text-[15px] leading-7 text-black/62 dark:text-white/62 sm:text-base">
                  WebImpact Lab builds websites for businesses in Kigali,
                  Rwanda, and East Africa that explain clearly, build trust,
                  rank on Google, and turn visitors into real leads.
                </p>

                <p className="mt-4 max-w-2xl text-sm font-semibold leading-6 text-black/78 dark:text-white/78">
                  We do not design for decoration. We design for clarity, trust,
                  search visibility, and customer action.
                </p>
              ...
              <div className="rounded-[2.25rem] border border-black/10 bg-white p-5 shadow-xl dark:border-white/10 dark:bg-[#070707] sm:p-6">
                ...
                <div className="mt-6 rounded-[1.75rem] border border-[#fd5b38]/20 bg-[#fd5b38]/10 p-5">
                  <p className="text-sm font-black text-[#fd5b38]">
                    Website-first promise
                  </p>
                  <p className="mt-2 text-sm leading-6 text-black/65 dark:text-white/65">
                    If a section does not help visitors understand, trust, or
                    take action, it does not belong on the page.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="relative border-t border-black/10 px-6 py-4 text-sm font-semibold text-black/55 dark:border-white/10 dark:text-white/55 sm:px-8 lg:px-12">
              Clear offer → Trust → Search visibility → Leads → Growth
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-10 lg:grid-cols-[0.42fr_1fr] lg:gap-16">
            <div className="lg:sticky lg:top-28 lg:self-start">
              ...
              <h2 className="mt-4 max-w-md text-[clamp(2rem,5vw,3.35rem)] font-semibold leading-[1] tracking-[-0.055em] text-black dark:text-white">
                Websites built like sales assets, not online brochures.
              </h2>

              <p className="mt-5 max-w-md text-[15px] leading-7 text-black/60 dark:text-white/60">
                A strong business website should explain your offer, create
                trust, answer buyer objections, rank for the right searches, and
            ...
            <div className="relative grid gap-10 lg:grid-cols-[0.85fr_1.15fr]">
              <div>
                ...
                <h2 className="mt-4 max-w-xl text-[clamp(2rem,5vw,3.35rem)] font-semibold leading-[1] tracking-[-0.055em] text-black dark:text-white">
                  A good website should make buyers trust you faster.
                </h2>

                <p className="mt-5 max-w-xl text-[15px] leading-7 text-black/62 dark:text-white/62">
                  Web development only matters if it helps the business get
                  found, understood, trusted, and contacted by better customers.
                </p>
              </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-10 lg:grid-cols-[0.42fr_1fr] lg:gap-16">
            <div>
              ...
              <h2 className="mt-4 max-w-md text-[clamp(2rem,5vw,3.35rem)] font-semibold leading-[1] tracking-[-0.055em] text-black dark:text-white">
                We build the message before we build the page.
              </h2>

              <p className="mt-5 max-w-md text-[15px] leading-7 text-black/60 dark:text-white/60">
                Most weak websites fail because the message is unclear. We start
                with the offer, then design the website around trust and action.
              </p>
            </div>
            ...
            <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                ...
                <h2 className="mt-4 max-w-2xl text-[clamp(2rem,5vw,3.35rem)] font-semibold leading-[1] tracking-[-0.055em] text-black dark:text-white">
                  Need a website that actually helps people choose you?
                </h2>

                <p className="mt-5 max-w-xl text-[15px] leading-7 text-black/60 dark:text-white/60">
                  Tell us what you sell, who you serve, and what your current
                  website is failing to do. We will help you turn it into a
                  clearer, stronger business website.
                </p>
              </div>
