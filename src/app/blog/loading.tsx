  ...
  return (
    <main className="bg-white px-4 py-12 dark:bg-[#070707] sm:px-6 lg:px-8 lg:py-20">
      <div className="mx-auto max-w-7xl">
        <div className="rounded-[15px] border border-black/10 bg-[#f7f7f7] p-5 shadow-2xl shadow-black/[0.06] dark:border-white/10 dark:bg-[#111111] sm:p-8 lg:p-12">
          ...
          <div className="mt-10 rounded-[15px] border border-black/10 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-[#070707]">
          ...
          <div className="mt-12 grid overflow-hidden rounded-[15px] border border-black/10 bg-white dark:border-white/10 dark:bg-[#070707] lg:grid-cols-[0.95fr_1fr]">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {Array.from({ length: 6 }).map((_, index) => (
              <article key={index} className="rounded-[15px] p-2">
                <div className="aspect-[4/3] animate-pulse rounded-[15px] bg-black/10 dark:bg-white/10" />
