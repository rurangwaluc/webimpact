    ...
    <main className="bg-white px-4 py-10 dark:bg-[#070707] sm:px-6 lg:px-8 lg:py-20">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_360px]">
          <section className="overflow-hidden rounded-[15px] border border-black/10 bg-[#f7f7f7] shadow-2xl shadow-black/[0.06] dark:border-white/10 dark:bg-[#111111]">
          ...
          <aside className="rounded-[15px] border border-black/10 bg-[#f7f7f7] p-6 dark:border-white/10 dark:bg-[#111111] lg:sticky lg:top-28 lg:self-start">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[minmax(0,1fr)_360px]">
          <article className="rounded-[15px] border border-black/10 bg-white p-6 dark:border-white/10 dark:bg-[#111111] sm:p-8 lg:p-10">
          ...
          <div className="rounded-[15px] border border-black/10 bg-white p-6 dark:border-white/10 dark:bg-[#111111]">
