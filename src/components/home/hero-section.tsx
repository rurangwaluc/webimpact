...
export function HeroSection() {
  return (
    <section className="w-full overflow-x-hidden px-3 pb-6 pt-3 sm:px-5 lg:pb-8">
      <div className="mx-auto max-w-7xl">
        <div className="bg-[#f7f4ef] shadow-2xl shadow-black/[0.06] dark:bg-[#080808]">
          <div className="grid lg:grid-cols-[0.94fr_1.06fr]">
            <div className="p-5 dark:text-white sm:p-8 lg:p-10 xl:p-12">
              ...
              <h1 className="mt-5 max-w-4xl text-[clamp(2.35rem,9vw,5.4rem)] font-bold leading-[0.88] tracking-[-0.078em] text-black dark:text-white">
              ...
              <div className="mt-6 grid gap-3 min-[430px]:grid-cols-2 sm:max-w-xl">
                <Link
                  href="/contact"
              ...
              <div className="mt-7 grid gap-2 border-t border-black/10 pt-5 dark:border-white/10">
            ...
            <div className="grid bg-[#101010] text-white sm:grid-cols-[0.88fr_1.12fr] lg:min-h-[610px]">
              <div className="grid gap-px bg-white/10 sm:grid-rows-[1fr_1fr_1fr_auto]">
              ...
              <div className="grid bg-[#f6f6f6] text-black dark:bg-[#070707] dark:text-white sm:grid-rows-[auto_1fr_auto]">
                ...
                <img
                  ...
                  className="h-[230px] w-full object-cover object-top sm:h-full sm:min-h-[360px]"
                />
              ...
              <div className="grid grid-cols-5 gap-px bg-white/10 sm:col-span-2">
                {buildSignals.map((item) => (
                  <div key={item} className="bg-[#101010] px-2 py-3 text-center text-[10px] font-black uppercase tracking-[0.1em] text-white/62 sm:px-3 sm:text-xs">
                    {item}
                  </div>
                ))}
              </div>
